...
//Gets the Announcement for the selected club
$result = mysql_query("SELECT announce,post_date FROM clubs WHERE club_id = '$sub'") or die ("Error in query: $query." . mysql_error());
