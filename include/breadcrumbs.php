...
class Breadcrumb{
   ...
   function output(){
      ...
      foreach ($this->crumbs as $crumb){  
         ...
         if ($crumb['url'] != null){
				echo '<li> <img src="css\img\next.png" height=10>'. "<a href='".$crumb['url']."' title='".$crumb['label']."'>".$crumb['label']."</a></li> ";
         } else {
				echo '<li> <img src="css\img\next.png" height=10>'.$crumb['label']."</li> ";
         }
      }
